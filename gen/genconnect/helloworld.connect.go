...
import (
	...
	context "context"
	errors "errors"
	gen "github.com/yehezkieldio/go-grpc-gateway-microservice/gen"
	http "net/http"
	strings "strings"
)
...
const (
	...
	GreeterName = "grpc.helloworld.v1.Greeter"
)
...
const (
	...
	GreeterSayHelloProcedure = "/grpc.helloworld.v1.Greeter/SayHello"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	greeterServiceDescriptor        = gen.File_helloworld_proto.Services().ByName("Greeter")
	greeterSayHelloMethodDescriptor = greeterServiceDescriptor.Methods().ByName("SayHello")
)

// GreeterClient is a client for the grpc.helloworld.v1.Greeter service.
type GreeterClient interface {
	SayHello(context.Context, *connect.Request[gen.HelloRequest]) (*connect.Response[gen.HelloResponse], error)
}

// NewGreeterClient constructs a client for the grpc.helloworld.v1.Greeter service. By default, it
...
// SayHello calls grpc.helloworld.v1.Greeter.SayHello.
...
// GreeterHandler is an implementation of the grpc.helloworld.v1.Greeter service.
...
func NewGreeterHandler(svc GreeterHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/grpc.helloworld.v1.Greeter/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedGreeterHandler) SayHello(context.Context, *connect.Request[gen.HelloRequest]) (*connect.Response[gen.HelloResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("grpc.helloworld.v1.Greeter.SayHello is not implemented"))
}
